...
public class ContactForm extends FormLayout { 
  ...
  public ContactForm(List<Company> companies, List<Status> statuses) {
    ...
    binder.forField(email).withValidator(new EmailValidator("Must be a valid email address")).withStatusLabel(emailStatus).bind(Contact::getEmail, Contact::setEmail);
    email.setErrorMessage("Enter a valid email address");
